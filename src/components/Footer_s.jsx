  ...
  return (
    <div>
      <div className=" bg-[#f5f2f2]">
        ...
        <div className=" flex py-12  px-4 justify-evenly  max-lg:gap-4 flex-wrap bg-[#f5f2f2] text-slate-600 ">
          ...
          <div className="w-[12rem] max-sm:w-[7rem]">
            ...
            <ul className=" flex flex-col font-mono font-bold gap-1 text-sm ">
              <li className=" font-mono hover:text-[var(--color-default)] duration-150">
                <a href="#">About Us</a>
              </li>
              <li className="font-mono hover:text-[var(--color-default)] duration-150">
                <a href="#">Contact</a>
      ...
      <div className="w-full min-h-10 p-2  max-[570px]:mb-14 bg-[var(--color-default)]  text-center text-white flex justify-center items-center font-mono">
