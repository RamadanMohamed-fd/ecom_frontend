...
const ListItem_Item = (props) => {
  return (
    <div
      className={`p-8 font-[11px] tracking-wider xl:absolute xl:bg-white hidden xl:ml-[300px] xl:-mt-8 xl:w-[810px] xl:group-hover:block z-20 ${
        props.show && 'max-[1115px]:block'
      }`}
    >
      <ul>
        <li>
